  ...
  const schema = new mongoose.Schema(
    {
      ...
      // An unconfirmed/unenforceable cancellation has no safe wall-clock expiry: remote work may
      // be configured without a duration limit. Mongo TTL ignores null. Confirmed owner-terminal
      // tombstones receive a bounded audit-retention expiry from VoiceTaskService.
