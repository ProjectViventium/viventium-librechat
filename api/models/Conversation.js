...
/* === VIVENTIUM START ===
 * Feature: Conversation Recall RAG proactive refresh on bulk conversation deletion
 * Added: 2026-02-19
 */
const {
...
module.exports = {
  ...
  deleteConvos: async (user, filter) => {
    try {
      ...
      /* === VIVENTIUM START ===
       * Feature: Conversation Recall RAG proactive refresh after conversation deletion
       * Added: 2026-02-19
       */
      scheduleConversationRecallRefresh({
        userId: String(user),
