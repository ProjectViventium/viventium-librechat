...
router.get('/', async function (req, res) {
  ...
  try {
    ...
    const payload = {
      // VIVENTIUM START
      // Purpose: Default branding and help links should use Viventium, not upstream names.
      // Details: docs/requirements_and_learnings/16_Branding_and_Assets.md#librechat-startup-config
      appTitle: process.env.APP_TITLE || 'Viventium',
