...
describe('ViventiumSourceSelectionContext', () => {
  ...
  test('keeps additive authoring scoped to the current source instead of reassigning siblings', () => {
    const req = {};
    setTrustedInteractionContext(
      req,
      {
        ...
        source_segments: [
          { source_event_id: 'source-a', source_index: 0, text: 'First accepted mission' },
          { source_event_id: 'source-b', source_index: 0, text: 'Second accepted mission' },
          { source_event_id: 'source-c', source_index: 0, text: 'Current accepted mission' },
        ],
      },
