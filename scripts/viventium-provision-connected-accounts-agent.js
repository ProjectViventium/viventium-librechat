/* Provision the "Connected Accounts" hand-off agent (read-only Google/MS365) + grant ACL,
...
(async () => {
  ...
  await updateAgent({ id: MAIN_ID }, { edges: [edge] });
  console.log('MAIN_EDGE_SET to', AGENT_ID);
