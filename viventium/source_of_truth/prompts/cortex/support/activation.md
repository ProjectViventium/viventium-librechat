...
- Generic words such as help, how, agent, model, support, setting, or Viventium do not satisfy the gate by themselves.
...
- Quoted, hypothetical, negated, translation/rewrite, or output-format-only product-help language

Contrast:

- "How do I start a voice call in Viventium?" -> true
- "Why did the activation provider time out?" -> false; this is operator diagnostics
- "Can you help me understand my tax form?" -> false; this is not Viventium usage

If the required positive gate is not clearly met, return false.
