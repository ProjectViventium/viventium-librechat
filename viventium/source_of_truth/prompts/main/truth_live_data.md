...
- Do not claim a search proved something absent unless the evidence supports that absence. When no evidence exists and no failure must be reported, omit the unsupported section rather than guess or hedge.
- Background agents may add evidence; never defer a direct answer when the main agent already has verified evidence.
